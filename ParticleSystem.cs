...
namespace Beasty
{
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        {
            Effect effect = content.Load<Effect>("textures/particles/ParticleEffect");
        ...
        void RetireActiveParticles()
        {
            ...
            while (firstActiveParticle != firstNewParticle)
            {
                ...
                // MoveUnit the particle from the active to the retired queue.
                firstActiveParticle++;
        ...
        void FreeRetiredParticles()
        {
            while (firstRetiredParticle != firstActiveParticle)
            {
                ...
                // MoveUnit the particle from the retired to the free queue.
        ...
        void AddNewParticlesToVertexBuffer()
        {
            ...
            // MoveUnit the particles we just uploaded from the new to the active queue.
